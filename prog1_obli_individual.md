...
Durante clase se discutió con el alumno su interés en realizar un proyecto alrededor del concepto. TBD.
...
- Como usuario quiero poder editar un equipo del torneo
  - Criterio de Aceptacion:
    - Cuando veo el listado, debo ver links o botones para editar un equipo
    - Cuando clickeo uno de esos links o botones, el formulario lateral debe ser completado con los datos del equipo que quiero editar, y un boton de guardar debe aparecer
    - Cuando hago click en guardar, el equipo debe ser actualizado con sus nuevos datos en el listado
...
- Como usuario quiero poder editar un ejercicio de mi lista
  - Criterio de Aceptacion:
    - Cuando veo el listado, debo ver links o botones para editar un ejercicio
    - Cuando clickeo uno de esos links o botones, el formulario lateral debe ser completado con los datos del ejercicio que quiero editar, y un boton de guardar debe aparecer
    - Cuando hago click en guardar, el ejercicio debe ser actualizado con sus nuevos datos en el listado
...
- Precargar una lista de categorías de ejercicios. Se sugiere: Físico, Técnico, Táctico, Estratégico, Mental
